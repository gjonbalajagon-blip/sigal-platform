...
function renderSpreadsheet(){
    ...
    h+='</div><span class="sp-hint">'+(spLocked?'🔒 Kyçur (nga oferta)':'Kliko çelulën për edit')+'</span></div>';
