...
function renderRow(k){
    ...
    return '<tr><td><div class="klient-name">'+k.emri+(k.arkivuar?' <span style="font-size:9px;color:#94a3b8;font-weight:600;">RINOVUAR</span>':'')+'</div><div class="klient-sub">'+(k.adresa||'')+'</div></td><td style="font-size:11px;color:#6b7a8d;">'+nrId+'</td><td><span class="badge-lloji '+k.lloji+'">'+(llojiLabels[k.lloji]||k.lloji)+'</span></td><td style="font-size:11px;color:#6b7a8d;">'+pakotTxt+'</td><td style="font-size:11px;color:#6b7a8d;">'+formatData(k.fillimi)+'</td><td><div class="skadon-cell '+skadonCls+'"><span class="skadon-dot"></span>'+ditet.teksti+'</div></td><td><span class="badge-status '+statusi+'">'+(statusLabels[statusi]||statusi)+'</span></td><td style="text-align:right;"><div class="action-icon-btns" style="justify-content:flex-end;"><button onclick="editoKontrate('+idx+')" title="Ndrysho" aria-label="Ndrysho"><i data-lucide="pencil"></i></button><button class="btn-word" onclick="gjeneroWord('+idx+')" title="Word" aria-label="Word"><i data-lucide="file-text"></i></button><button onclick="dergoEmail('+idx+')" title="Email" aria-label="Email"><i data-lucide="mail"></i></button><button onclick="fshijKontrate('+idx+')" title="Fshij" aria-label="Fshij"><i data-lucide="trash-2"></i></button></div></td></tr>';
}
